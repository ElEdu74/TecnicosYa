...
module.exports = (app) => {
    ...
    app.get('/api/orders/findByTechnicalAndStatus/:id_technical/:status/:id_zone', passport.authenticate('jwt', { session: false }), ordersController.findByTechnicalAndStatus);
